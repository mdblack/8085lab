...
void memory_write(P8085* p8085, unsigned int address, unsigned int data)
{
	p8085->memory[address]=data;
}

unsigned int memory_read(P8085* p8085, unsigned int address)
{
...
void doInstruction8085(P8085* p8085)
{
	...
	switch(opcode)
	{
		...
		case 0x02: name="stax b"; m=2; t=7;
			memory_write(p8085,(p8085->B<<8)|p8085->C, (unsigned char)p8085->A);
			break;
		...
		case 0x0a: name="ldax b"; m=2; t=7;
			p8085->A=memory_read(p8085,(p8085->B<<8)|p8085->C)&0xff;
			break;
		...
		case 0x12: name="stax d"; m=2; t=7;
			memory_write(p8085,(p8085->D<<8)|p8085->E, (unsigned char)p8085->A);
			break;
		...
		case 0x1a: name="ldax d"; m=2; t=7;
			p8085->A=memory_read(p8085,(p8085->D<<8)|p8085->E)&0xff;
			break;
		...
		case 0x22: name="shld"; m=5; t=16;
			...
			memory_write(p8085,value,(unsigned char)p8085->L);
			value=(value+1)&0xffff;
			memory_write(p8085,value,(unsigned char)p8085->H);
			break;
		...
		case 0x2a: name="lhld"; m=5; t=16;
			value=fetch(p8085); value2=fetch(p8085);
			value=(value2<<8)|value;
			p8085->L=memory_read(p8085,value)&0xff;
			value=(value+1)&0xffff;
			p8085->H=memory_read(p8085,value)&0xff;
			break;
		...
		case 0x32: name="sta"; m=3; t=13;
			value=fetch(p8085);
			value|=fetch(p8085)<<8;
			memory_write(p8085,value,(unsigned char)p8085->A);
			break;
		...
		case 0x34: name="inr m"; m=3; t=10;
			value2=(p8085->H<<8)|p8085->L;
			value=memory_read(p8085,value2)&0xff;
			value++;
			p8085->p=(((value>>7)^(value>>6)^(value>>5)^(value>>4)^(value>>3)^(value>>2)^(value>>1)^(value))&1)==0? 1:0;
			p8085->ac=(value&0xf)==0?1:0;
			p8085->s=((value&0x80)!=0)?1:0;
			p8085->z=((value&0xff)==0)?1:0;
			value=value&0xff;
			memory_write(p8085,value2,(unsigned char)value);
			break;
		...
		case 0x36: name="mvi m"; m=3; t=10;
			...
			memory_write(p8085,(p8085->H<<8)|p8085->L,(unsigned char)value);
			break;
		...
		case 0x3a: name="lda"; m=3; t=13;
			value=fetch(p8085);
			value|=fetch(p8085)<<8;
			p8085->A=memory_read(p8085,value)&0xff;
			break;
		...
		case 0x46: name="mov b M"; m=2; t=7; p8085->B=memory_read(p8085,(p8085->H<<8)|p8085->L)&0xff; break;
		...
		case 0x4e: name="mov c M"; m=2; t=7; p8085->C=memory_read(p8085,(p8085->H<<8)|p8085->L)&0xff; break;
		...
		case 0x56: name="mov d M"; m=2; t=7; p8085->D=memory_read(p8085,(p8085->H<<8)|p8085->L)&0xff; break;
		...
		case 0x5e: name="mov e M"; m=2; t=7; p8085->E=memory_read(p8085,(p8085->H<<8)|p8085->L)&0xff; break;
		...
		case 0x66: name="mov h M"; m=2; t=7; p8085->H=memory_read(p8085,(p8085->H<<8)|p8085->L)&0xff; break;
		...
		case 0x6e: name="mov l M"; m=2; t=7; p8085->L=memory_read(p8085,(p8085->H<<8)|p8085->L)&0xff; break;
		case 0x6f: name="mov l a"; m=1; t=4; p8085->L=p8085->A; break;
		case 0x70: name="mov M b"; m=2; t=7; memory_write(p8085,(p8085->H<<8)|p8085->L,(unsigned char)p8085->B); break;
		case 0x71: name="mov M c"; m=2; t=7; memory_write(p8085,(p8085->H<<8)|p8085->L,(unsigned char)p8085->C); break;
		case 0x72: name="mov M d"; m=2; t=7; memory_write(p8085,(p8085->H<<8)|p8085->L,(unsigned char)p8085->D); break;
		case 0x73: name="mov M e"; m=2; t=7; memory_write(p8085,(p8085->H<<8)|p8085->L,(unsigned char)p8085->E); break;
		case 0x74: name="mov M h"; m=2; t=7; memory_write(p8085,(p8085->H<<8)|p8085->L,(unsigned char)p8085->H); break;
		case 0x75: name="mov M l"; m=2; t=7; memory_write(p8085,(p8085->H<<8)|p8085->L,(unsigned char)p8085->L); break;
		case 0x76: name="hlt"; m=2; t=7; halt(p8085); break;
		case 0x77: name="mov M a"; m=2; t=7; memory_write(p8085,(p8085->H<<8)|p8085->L,(unsigned char)p8085->A); break;
		...
		case 0x7e: name="mov a M"; m=2; t=7; p8085->A=memory_read(p8085,(p8085->H<<8)|p8085->L)&0xff; break;
		...
		case 0x86: name="add M"; m=2; t=7;
			value2=memory_read(p8085,(p8085->H<<8)|p8085->L)&0xff;
			result=p8085->A+value2;
			p8085->ac=(((p8085->A&0xf)+(value2&0xf))&0x10)!=0? 1:0;
			p8085->c=(result&0x100)!=0?1:0;
			p8085->s=(result&0x80)!=0?1:0;
		...
		case 0xa6: name="ana M"; m=2; t=7;
			p8085->A&=memory_read(p8085,(p8085->H<<8)|p8085->L)&0xff;
			p8085->s=(p8085->A&0x80)!=0?1:0; p8085->z=(p8085->A==0)?1:0; p8085->ac=1; p8085->c=0; value=p8085->A; p8085->p=(((value>>7)^(value>>6)^(value>>5)^(value>>4)^(value>>3)^(value>>2)^(value>>1)^(value))&1)==0? 1:0;
			break;
		...
		case 0xc0: name="rnz";
			...
			{
				m=3; t=12;
				value=memory_read(p8085,p8085->SP)&0xff;
				p8085->SP=(p8085->SP+1)&0xffff;
				value|=(memory_read(p8085,p8085->SP)&0xff)<<8;
				p8085->SP=(p8085->SP+1)&0xffff;
				p8085->PC=value;
			}
			else { m=1; t=6; }
		...
		case 0xc1: name="pop b"; m=3; t=10;
			p8085->C=memory_read(p8085,p8085->SP)&0xff;
			p8085->SP=(p8085->SP+1)&0xffff;
			p8085->B=memory_read(p8085,p8085->SP)&0xff;
			p8085->SP=(p8085->SP+1)&0xffff;
			break;
		case 0xc2: name="jnz";
		...
		case 0xc4: name="cnz";
			...
			if(p8085->z==0)
			{
				m=5; t=18;
				p8085->SP=(p8085->SP-1)&0xffff;
				memory_write(p8085,p8085->SP,(unsigned char)((p8085->PC>>8)&0xff));
				p8085->SP=(p8085->SP-1)&0xffff;
				memory_write(p8085,p8085->SP,(unsigned char)(p8085->PC&0xff));
				p8085->PC=value;
			}
			else { m=2; t=9; }
			break;
		case 0xc5: name="push b"; m=3; t=12;
			p8085->SP=(p8085->SP-1)&0xffff;
			memory_write(p8085,p8085->SP,(unsigned char)p8085->B);
			p8085->SP=(p8085->SP-1)&0xffff;
			memory_write(p8085,p8085->SP,(unsigned char)p8085->C);
			break;
		...
		case 0xd1: name="pop d"; m=3; t=10;
			p8085->E=memory_read(p8085,p8085->SP)&0xff;
			p8085->SP=(p8085->SP+1)&0xffff;
			p8085->D=memory_read(p8085,p8085->SP)&0xff;
			p8085->SP=(p8085->SP+1)&0xffff;
			break;
		case 0xd2: name="jnc";
			value=fetch(p8085)|(fetch(p8085)<<8);
		...
		case 0xd5: name="push d"; m=3; t=12;
			p8085->SP=(p8085->SP-1)&0xffff;
			memory_write(p8085,p8085->SP,(unsigned char)p8085->D);
			p8085->SP=(p8085->SP-1)&0xffff;
			memory_write(p8085,p8085->SP,(unsigned char)p8085->E);
			break;
		...
		case 0xe1: name="pop h"; m=3; t=10;
			p8085->L=memory_read(p8085,p8085->SP)&0xff;
			p8085->SP=(p8085->SP+1)&0xffff;
			p8085->H=memory_read(p8085,p8085->SP)&0xff;
			p8085->SP=(p8085->SP+1)&0xffff;
			break;
		case 0xe2: name="jpo";
			value=fetch(p8085)|(fetch(p8085)<<8);
		...
		case 0xe3: name="xthl"; m=5; t=16;
			value=p8085->L;
			p8085->L=memory_read(p8085,p8085->SP)&0xff;
			memory_write(p8085,p8085->SP,(unsigned char)value);
			value=p8085->H;
			p8085->H=memory_read(p8085,(p8085->SP+1)&0xffff)&0xff;
			memory_write(p8085,(p8085->SP+1)&0xffff,(unsigned char)value);
			break;
		case 0xe4: name="cpo";
			value=fetch(p8085)|(fetch(p8085)<<8);
			if(p8085->p==0)
		...
		case 0xe5: name="push h"; m=3; t=12;
			p8085->SP=(p8085->SP-1)&0xffff;
			memory_write(p8085,p8085->SP,(unsigned char)p8085->H);
			p8085->SP=(p8085->SP-1)&0xffff;
			memory_write(p8085,p8085->SP,(unsigned char)p8085->L);
			break;
		...
		case 0xf1: name="pop psw"; m=3; t=10;
			value=memory_read(p8085,p8085->SP)&0xff;
			p8085->SP=(p8085->SP+1)&0xffff;
			p8085->A=memory_read(p8085,p8085->SP)&0xff;
			p8085->SP=(p8085->SP+1)&0xffff;
		...
		case 0xf5: name="push psw"; m=3; t=12;
			...
			p8085->SP=(p8085->SP-1)&0xffff;
			memory_write(p8085,p8085->SP,(unsigned char)p8085->A);
			p8085->SP=(p8085->SP-1)&0xffff;
			memory_write(p8085,p8085->SP,(unsigned char)value);
			break;
